...
Flight.create!(number: '163', origin: "DFW", destination: "JFK", price: "223")
Flight.create!(number: '163', origin: "DFW", destination: "LAS", price: "223")
Flight.create!(number: '163', origin: "DFW", destination: "LAX", price: "223")
Flight.create!(number: '163', origin: "PIT", destination: "LAS", price: "223")
Flight.create!(number: '163', origin: "JFK", destination: "LAX", price: "223")
Flight.create!(number: '163', origin: "PIT", destination: "LAS", price: "223")
Flight.create!(number: '163', origin: "LAS", destination: "LAX", price: "223")
Flight.create!(number: '163', origin: "JFK", destination: "LAS", price: "223")
Flight.create!(number: '163', origin: "PIT", destination: "JFK", price: "223")
...
AirportJoin.create!(airport_id: 1, destination_id: 6)
AirportJoin.create!(airport_id: 1, destination_id: 5)
AirportJoin.create!(airport_id: 1, destination_id: 8)
AirportJoin.create!(airport_id: 2, destination_id: 3)
AirportJoin.create!(airport_id: 2, destination_id: 1)
AirportJoin.create!(airport_id: 2, destination_id: 5)
AirportJoin.create!(airport_id: 1, destination_id: 4)
AirportJoin.create!(airport_id: 3, destination_id: 3)
AirportJoin.create!(airport_id: 3, destination_id: 1)
AirportJoin.create!(airport_id: 4, destination_id: 3)
AirportJoin.create!(airport_id: 5, destination_id: 2)
AirportJoin.create!(airport_id: 6, destination_id: 5)
AirportJoin.create!(airport_id: 7, destination_id: 4)
AirportJoin.create!(airport_id: 8, destination_id: 3)